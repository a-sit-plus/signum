...
/**
 * Encodes a [CryptoPrivateKey.WithPublicKey] to DER without requiring explicit serializer arguments.
 *
 * This overload exists to avoid star-projection friction in call sites.
 */
@ExperimentalSerializationApi
fun Der.encodeToDer(value: CryptoPrivateKey.WithPublicKey<*>) = encodeToDer(CryptoPrivateKey.Companion, value)

/**
 * Encodes a [CryptoPrivateKey.WithPublicKey] to a TLV element without requiring explicit serializer arguments.
 *
 * This overload exists to avoid star-projection friction in call sites.
 */
@ExperimentalSerializationApi
...
/**
 * Decodes a TLV [source] into [CryptoPrivateKey.WithPublicKey] without requiring explicit serializer arguments.
 */
@ExperimentalSerializationApi
...
/**
 * Decodes DER [source] into [CryptoPrivateKey.WithPublicKey] without requiring explicit serializer arguments.
 */
@ExperimentalSerializationApi
