 ...
 *
 * Signers for your platform can be accessed using `PlatformSigningProvider`, provided by Supreme.
 *
 ...
 * }
 * ```
 * This will generate a temporary key and return a Signer for it.
 *
 * Instantiations may also be [WithAlias], usually because they come from a signing provider.
...
interface Signer {
    ...
    interface ECDSA : Signer, UsableECDHPrivateValue {
