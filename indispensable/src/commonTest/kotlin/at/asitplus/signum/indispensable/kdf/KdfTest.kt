...
val KdfTest by testSuite {
    ...
    "Invoke Overrides" {
        ...
        (List(10000) { it + 1 }).forEach {
            ...
            PBKDF2.HMAC_SHA256.WithIterations(it) shouldBe PBKDF2.HMAC_SHA256(it)
                .apply { pbkdf2 shouldBe PBKDF2.HMAC_SHA256 }
            PBKDF2.HMAC_SHA384.WithIterations(it) shouldBe PBKDF2.HMAC_SHA384(it)
                .apply { pbkdf2 shouldBe PBKDF2.HMAC_SHA384 }
            PBKDF2.HMAC_SHA512.WithIterations(it) shouldBe PBKDF2.HMAC_SHA512(it)
                .apply { pbkdf2 shouldBe PBKDF2.HMAC_SHA512 }
            ...
            HKDF.SHA1.WithInfo(it.encodeToAsn1ContentBytes()) shouldBe HKDF.SHA1(it.encodeToAsn1ContentBytes())
                .apply { hkdf shouldBe HKDF.SHA1 }
            HKDF.SHA256.WithInfo(it.encodeToAsn1ContentBytes()) shouldBe HKDF.SHA256(it.encodeToAsn1ContentBytes())
                .apply { hkdf shouldBe HKDF.SHA256 }
            HKDF.SHA384.WithInfo(it.encodeToAsn1ContentBytes()) shouldBe HKDF.SHA384(it.encodeToAsn1ContentBytes())
                .apply { hkdf shouldBe HKDF.SHA384 }
            HKDF.SHA512.WithInfo(it.encodeToAsn1ContentBytes()) shouldBe HKDF.SHA512(it.encodeToAsn1ContentBytes())
                .apply { hkdf shouldBe HKDF.SHA512 }
