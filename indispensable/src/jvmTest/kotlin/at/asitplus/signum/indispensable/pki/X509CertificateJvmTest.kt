...
class X509CertificateJvmTest : FreeSpec({
    ...
    "Certificate can be parsed" {
        ...
        x509Certificate.tbsCertificate.validUntil.instant shouldBe notAfterDate.toInstant()
            .truncatedTo(ChronoUnit.SECONDS)
            .toKotlinInstant()
        val parsedPublicKey = x509Certificate.tbsCertificate.decodedPublicKey
    ...
    "Equals & hashCode" {
        ...
        */
        ...
        val signatureAlgorithm256 = X509SignatureAlgorithm.Supported.ES256
        val signatureAlgorithm512 = X509SignatureAlgorithm.Supported.ES512
