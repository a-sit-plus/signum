...
internal fun X509SignatureAlgorithm.Supported.getContentSigner(key: PrivateKey) =
...
class Pkcs10CertificationRequestJvmTest : FreeSpec({
    ...
    "CSR match" {
        ...
        val signatureAlgorithm = X509SignatureAlgorithm.Supported.ES256
    ...
    "Equals & hashCode" {
        ...
        */
        val signatureAlgorithm1 = X509SignatureAlgorithm.Supported.ES256
        val signatureAlgorithm2 = X509SignatureAlgorithm.Supported.ES512
