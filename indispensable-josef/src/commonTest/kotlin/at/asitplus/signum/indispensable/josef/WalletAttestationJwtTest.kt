...
val WalletAttestationJwtTest by matrixSuite {
    ...
    "Wallet Instance Attestation" {
        ...
        joseCompliantSerializer.decodeFromString<WalletAttestationPayload>(joseCompliantSerializer.encodeToString(parsed)) shouldBe parsed
    }
}
