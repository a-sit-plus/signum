    ...
    "Serializing" - {
        "Manual" - {
            ...
            "Now with autogenerated foo when encapsulating into an Array" {
                val willWorkRegardless= cborSerializer.encodeToByteArray(coseKey)
                cborSerializer.decodeFromByteArray<CoseKey>(willWorkRegardless).apply {
                  this shouldBe coseKey
                }
