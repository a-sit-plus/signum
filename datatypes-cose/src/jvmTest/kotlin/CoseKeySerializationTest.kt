...
class CoseKeySerializationTest : FreeSpec({
    ...
    "Serializing" - {
        "Manual" - {
            ...
            val coseKey = CryptoPublicKey.fromJcaPublicKey(
            ...
            "Now with autogenerated foo when encapsulating into an Array" {
                val willWorkRegardless= cborSerializer.encodeToByteArray(arrayOf( coseKey))
                cborSerializer.decodeFromByteArray<Array<CoseKey>>(willWorkRegardless).apply {
