...
import at.asitplus.signum.indispensable.pki.CertificatePolicyException
...
import at.asitplus.signum.indispensable.pki.extn.PolicyQualifierInfo
...
class PolicyValidator: CertificateChainValidator {
    ...
    */
    private fun updateExplicitPolicy(
        ...
        val constraints =
            currentCert.findExtension<PolicyConstraints>()
                ?: return result
    ...
    */
    private fun updateInhibitAnyPolicy(
        ...
        val extensionValue =
            currentCert.findExtension<InhibitAnyPolicy>()?.skipCerts
    ...
    private fun processPolicies(
        ...
        val policyExtension =
            currentCert.findExtension<CertificatePolicies>()
    ...
    */
    ...
    private fun processPolicyMappings(
        ...
        val policyMappingsExtension =
            certificate.findExtension<PolicyMappings>() ?: return root
    ...
    */
    ...
    private fun removeInvalidNodes(
        ...
        certDepth: Int,
        initialPolicies: Set<ObjectIdentifier>,
        currentExtension: CertificatePolicies
    ): PolicyNode? {
