...
private fun EcPublicKey.withCompressionPreference(v: Boolean) =
    if (v) EcPublicKey.fromCompressed(curve, xBytes, yCompressed)
    else EcPublicKey.fromUncompressed(curve, xBytes, yBytes)
        ...
        "Manual" - {
            ...
            "Basic Checks" {
                ...
                coseKey.toCryptoPublicKey().getOrThrow()
                    .shouldBeInstanceOf<EcPublicKey>().preferCompressedRepresentation shouldBe true
                coseCompliantSerializer.decodeFromByteArray<CoseKey>(uncompressed).toCryptoPublicKey()
                    .getOrThrow()
                    .shouldBeInstanceOf<EcPublicKey>().preferCompressedRepresentation shouldBe false
                ...
                withData(
                    ...
                    val coseKey: CoseKey =
                        pubKey.toCryptoPublicKey().getOrThrow()
                            .toCoseKey(at.asitplus.signum.indispensable.cosef.algorithm.CoseAlgorithm.Signature.RS256)
                            .getOrThrow()
                    val cose = coseCompliantSerializer.encodeToByteArray(coseKey)
