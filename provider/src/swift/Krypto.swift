...
@objc public class Krypto: NSObject {
    ...
    {
        switch alg {
            case "ECDSA_P256_SHA256": return try String(verifyECDSA_P256SHA256(pubkeyDER, sigDER, data))
            case "ECDSA_P384_SHA384": return try String(verifyECDSA_P384SHA384(pubkeyDER, sigDER, data))
            case "ECDSA_P521_SHA512": return try String(verifyECDSA_P521SHA512(pubkeyDER, sigDER, data))
