    ...
    "Cert signing" - {
        "RSA" - {
            withData(TestSuites.RSA) { (padding, digest, keySize, preHashed) ->
                ...
                val verifier = signer.makeVerifier().getOrThrow()
                verifier.verify(signedCSR.tbsCsr.encodeToDer(), signedCSR.decodedSignature!!) should succeed
                ...
                verifier.verify(cert.tbsCertificate.encodeToDer(), cert.decodedSignature!!) should succeed
