    ...
    "RFC2898 PBKDF2" - {
        "PBKDF2-HMAC-SHA-1" - {
            withData(nameFn = { "RFC6070: \"${it.d}\"" }, sequence {
                ...
                yield(
                    Quadruple(
                        "pass\u0000word", "sa\u0000lt", 4096, "" +
                                "56 fa 6a a7 55 48 09 9d\n" +
                                "            cc 37 d7 f0 34 25 e0 c3"
                    )
                )
            }) { (P, S, c, ref) ->
                PBKDF2.HMAC_SHA1.WithIterations(c)
        ...
        "PBKDF2-HMAC-SHA-256" - {
            "RFC7914: passwd" {
                PBKDF2.HMAC_SHA256.WithIterations(1)
            ...
            "RFC7914: Password" {
                PBKDF2.HMAC_SHA256.WithIterations(iterations = 80000)
