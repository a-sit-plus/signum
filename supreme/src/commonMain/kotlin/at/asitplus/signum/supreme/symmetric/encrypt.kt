...
fun <K: KeyType,A : AuthCapability<out K>, I : WithNonce> SymmetricKey<A, I,out K>.encrypt(
    data: ByteArray
...
fun <K: KeyType, A : AuthCapability.Authenticated<K>, I : WithNonce> SymmetricKey<A, I,out K>.encrypt(
    data: ByteArray,
