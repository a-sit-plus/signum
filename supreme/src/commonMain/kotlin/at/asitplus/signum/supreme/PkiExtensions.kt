 ...
 */
suspend fun Signer.sign(tbsCertificate: TbsCertificate): KmmResult<Certificate> {
...
/**
 * Shorthand helper to create a [CertificateSigningRequest] by signing [tbsCsr]
 */
suspend fun Signer.sign(tbsCsr: TbsCertificationRequest): KmmResult<CertificateSigningRequest> {
    val toX509SignatureAlgorithm =
        this.signatureAlgorithm.toX509SignatureAlgorithm().getOrElse { return KmmResult.failure(it) }
