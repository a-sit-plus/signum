 ...
 */
suspend fun SignatureAlgorithm.signerFor(privateKey: CryptoPrivateKey.WithPublicKey<*>): KmmResult<Signer> =
...
suspend fun SignatureAlgorithm.ECDSA.signerFor(privateKey: CryptoPrivateKey.EC.WithPublicKey) =
    catching { makePrivateKeySigner(privateKey, this) }

suspend fun SignatureAlgorithm.RSA.signerFor(privateKey: CryptoPrivateKey.RSA) =
    catching { makePrivateKeySigner(privateKey, this) }
 ...
 */
suspend fun Signer.makeVerifier(configure: ConfigurePlatformVerifier = null) =
 ...
 */
suspend fun Signer.makePlatformVerifier(configure: ConfigurePlatformVerifier = null) =
