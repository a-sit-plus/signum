...
fun SignatureAlgorithm.signerFor(privateKey: CryptoPrivateKey<*>): KmmResult<Signer> = catching {
    ...
    when(this) {
        ...
        is SignatureAlgorithm.ECDSA ->  makePrivateKeySigner((privateKey as CryptoPrivateKey.EC).withOverriddenCurve(this.requiredCurve), this)
...
/**
 * Creates a copy of this key, overriding the curve. Performs no sanity checks
 */
private fun CryptoPrivateKey.EC.withOverriddenCurve(curve: ECCurve?) = CryptoPrivateKey.EC(curve, privateKeyBytes, encodeCurve, null)
