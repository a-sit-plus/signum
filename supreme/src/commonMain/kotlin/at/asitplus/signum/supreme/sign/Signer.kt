 ...
 */
fun SignatureAlgorithm.signerFor(privateKey: CryptoPrivateKey.WithPublicKey<*>): Signer =
    if ((this is ECDSAAlgorithm && privateKey is ECDSAPrivateKey) ||
        ...
        error("Algorithm and Key mismatch: ${this::class.simpleName} + ${privateKey::class.simpleName}")
    }

fun ECDSAAlgorithm.signerFor(privateKey: ECDSAPrivateKey.WithPublicKey) =
    makePrivateKeySigner(privateKey, this)
